<?php
require_once __DIR__ . '/../Controller/EditarDadosController.php';
require_once __DIR__ . '/../Controller/AdminController.php';
session_start();
$adm = new AdminController();
if ($adm->isLogado($_SESSION["assinante"]) ){
  $controller = new EditarDadosController();
  $controller->onEditar();
  $assinante = $_SESSION["assinante"];
}else{
        ...
        <div class="card-body text-muted m-3">
          <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="col-12" id="formulario">
            ...
            <div class="form-group mb-5">
              <p class="h4 text-center py-4">Atualizar Dados</h3>
              </div>
              ...
              <div class="text-center mt-4">
                <button type="submit" class="btn btn-lg btn-primary" name="btnatualizar">Atualizar</button>
              </div>
            </div>
          </div>
        </form>
